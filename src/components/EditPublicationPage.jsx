...
// Tidak perlu import uploadImageToCloudinary di sini
...
export default function EditPublicationPage() {
    ...
    // handleUpdate sekarang menjadi jauh lebih sederhana
    const handleUpdate = async (formDataFromForm) => {
        ...
        try {
            // 1. Gabungkan data dari form dengan URL yang sudah ada
            const payload = {
                ...formDataFromForm,
                existingCoverUrl: publication.coverUrl 
            };
            
            // 2. Langsung kirim payload ke service
    ...
    return (
        <div className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg">
            ...
            <PublicationForm
                ...
                buttonText={isSubmitting ? 'Menyimpan...' : 'Simpan Perubahan'}
