...
export default function PublicationForm({ onSubmit, publication, buttonText, isSubmitting }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" rows={4}
                />
            </div>
            <div>
            ...
            <div>
                ...
                <input
                    type="file" id="cover" accept="image/*" onChange={(e) => setCoverFile(e.target.files[0])}
            ...
            <div className="flex justify-end space-x-4 pt-4">
                <button
                    type="button" onClick={() => navigate('/publications')}
                ...
                <button
                    type="submit"
                    className="bg-sky-700 hover:bg-sky-800 text-white font-bold py-2 px-6 rounded-lg disabled:bg-sky-400"
